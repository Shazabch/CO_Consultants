...
import { Trash2, RotateCcw, X, FileText, Archive, Image, Video, File } from "lucide-react";
...
export default function TrashPage() {
  ...
  const handleEmptyTrash = async () => {
    if (!window.confirm('Are you sure you want to empty the trash? This will permanently delete all files and cannot be undone.')) {
      return;
    }
