...
import { Star, Download, Trash2, Share2, FileText, Archive, Image, Video, File } from "lucide-react";
    ...
    return (
      <div className="space-y-6">
        <div className="flex items-center gap-2">
          ...
          <h1 className="text-2xl font-semibold text-foreground">Starred Files</h1>
        </div>
