      ...
      <section className="pt-24 pb-16 px-4 sm:px-6 lg:px-8">
        <div className="container mx-auto">
          <div className="max-w-6xl mx-auto">
            ...
            >
              About CO Consultants Technologies
            </motion.h1>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mb-16">
                ...
                >
                  ...
                  <p className="text-gray-600">
                    At CO Consultants Technologies, we're on a mission to
                    transform ordinary textiles into intelligent, data-driven
                    solutions that improve safety, performance, and quality of
