  ...
  const onSubmit = async (data: FormValues) => {
    ...
    try {
      ...
      const templateParams = {
        ...
        to_name: "CO Consultants Team", // Adding recipient name parameter
    ...
    >
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <div className="bg-white rounded-xl shadow-xl p-8 border border-gray-300 text-foreground">
            <Form {...form}>
              <form
              ...
              >
                ...
                <button
                  ...
                  className="w-full bg-primary hover:bg-primary/90 text-primary-foreground py-3 px-6 rounded-md transition-colors flex items-center justify-center disabled:opacity-70"
                >
                  {isSubmitting ? (
                    "Sending..."
                  ) : (
          ...
          <div className="space-y-8">
            <div className="bg-white p-6 rounded-lg shadow-md border border-gray-300 text-foreground">
              ...
              <a
                href="mailto:info@CO Consultants.com"
                className="text-blue-500 hover:underline"
              >
                hello@CO Consultants.com
              </a>
