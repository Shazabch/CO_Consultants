                ...
                <NavigationMenuList className="space-x-6">
                    ...
                    <NavigationMenuContent>
                      <div className="grid gap-3 p-6 w-[400px] lg:w-[500px] lg:grid-cols-2">
                        ...
                        >
                          ...
                          <p className="line-clamp-2 text-sm leading-snug text-muted-foreground">
                            Sports equipment retail solutions
                          </p>
                        </Link>
                        <Link
                        ...
                        >
                          ...
                          <p className="line-clamp-2 text-sm leading-snug text-muted-foreground">
                            Pet tracking and monitoring system
                          </p>
                        </Link>
                      </div>
                    </NavigationMenuContent>
                  ...
                  <NavigationMenuItem>
                    <button
                      ...
                      className={cn(
                        "px-4 py-2 rounded-md transition-colors bg-primary text-primary-foreground hover:bg-primary/80"
                      )}
                    >
                      Contact Us
                    </button>
        ...
        >
          ...
          <button
            ...
            className={cn(
              "block w-full text-left px-3 py-1.5 rounded-md text-sm",
              isScrolled
                ? "text-gray-700 bg-secondary hover:bg-secondary/80 text-white"
