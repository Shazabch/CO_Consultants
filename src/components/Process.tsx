...
const processes = [{
  ...
  steps: ["Integrate with Excel, RTLS, QR systems", "Deploy tracking devices", "Validate & clean data", "System integration testing"]
}, {
  id: 2,
  ...
  steps: ["Visual reporting via Power BI", "Custom KPIs development", "Predictive insights implementation", "Dashboard customization"]
}, {
  id: 3,
  ...
  steps: ["Staff training programs", "24/7 technical support", "Continuous system refinement", "Performance optimization"]
}];
                ...
                >
                  <div className="flex items-center">
                    ...
                    <span className={cn(
                      ...
                      activeProcess === process.id ? "text-primary font-semibold" : "text-gray-600"
                    )}>
                      {process.title}
                    </span>
                  </div>
                ...
                >
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    {process.steps.map((step, idx) => (
                      <div key={idx} className="bg-gradient-to-r from-primary/5 to-primary/10 p-4 rounded-lg border border-primary/20 hover:shadow-md transition-all duration-300 hover:scale-105">
                        <div className="flex items-center">
