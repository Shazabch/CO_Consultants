...
import { Activity, Shield, HardHat, Zap, ArrowRight, Box, Truck, Code, CheckCircle, Rocket, Factory, Microchip, Handshake, RefreshCcw, MessageSquare, BarChart } from "lucide-react";
...
const Features = () => {
  ...
  const features = [
    {
      ...
      description: "Visualize manpower & progress trends, identify bottlenecks instantly, and track KPIs with precision.",
    ...
    },
    {
      ...
      description: "Bluetooth RTLS & RFID integration, QR-code access logs, and indoor/outdoor positioning.",
    ...
    },
    {
      ...
      description: "Predictive analytics, timeline estimation, and resource modeling for accurate project planning.",
  ...
  const stepFlowItems = [{
    ...
    description: "RTLS, RFID, QR-codes, and Excel integration for comprehensive tracking"
  }, {
    icon: <Factory className="h-10 w-10 text-gray-700" />,
    title: "Analytics & Dashboards",
    description: "Power BI visualizations with custom KPIs and predictive insights"
  }, {
        ...
        <div className="w-full px-4 sm:px-6 lg:px-8" ref={featuresRef}> 
          <div className="text-center mb-10 max-w-3xl mx-auto feature-item">
            ...
            <p className="text-gray-600 mt-4">
              Transform your construction projects with real-time data insights, advanced tracking systems, and predictive analytics that reduce delays and optimize performance.
            </p>
          </div>
          ...
          <div className="mt-16 mb-8 feature-item">
            <div className="text-center mb-8">
              ...
              <h3 className="text-2xl font-bold">Digitally Transform Your Construction Projects</h3>
              <p className="text-gray-600 mt-3 max-w-2xl mx-auto">
                Let us show you how to reduce delays, optimize crews, and plan better with real data.
                Get a comprehensive dashboard walkthrough, site performance review, and ROI forecast.
              </p>
            </div>
            
            <div className="rounded-xl overflow-hidden bg-white p-4 feature-item">
              <div className="text-center">
                <h4 className="text-xl font-bold mb-4">What's Included in Your Demo</h4>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                  <div className="bg-gray-50 p-6 rounded-lg">
                    <h5 className="font-semibold mb-2">Dashboard Walkthrough</h5>
                    <p className="text-sm text-gray-600">See your construction data come to life with real-time visualizations and insights.</p>
                  </div>
                  <div className="bg-gray-50 p-6 rounded-lg">
                    <h5 className="font-semibold mb-2">Site Performance Review</h5>
                    <p className="text-sm text-gray-600">Analyze your current project data and identify optimization opportunities.</p>
                  </div>
                  <div className="bg-gray-50 p-6 rounded-lg">
                    <h5 className="font-semibold mb-2">ROI Forecast</h5>
                    <p className="text-sm text-gray-600">Understand the potential cost savings and efficiency gains for your projects.</p>
                  </div>
                </div>
              </div>
            </div>
      ...
      <section id="technology" className="bg-gray-50 py-10 md:py-16">
        <div className="w-full px-4 sm:px-6 lg:px-8 max-w-6xl mx-auto">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl font-bold mb-4">How our construction analytics work</h2>
            <p className="text-gray-600 max-w-3xl mx-auto">
              CO Consultants integrates multiple data sources and tracking technologies with powerful analytics, 
              allowing us to deliver complete construction intelligence solutions with minimal risk and maximum impact.
            </p>
          </div>
              ...
              {stepFlowItems.map((item, index) => <HoverCard key={index}>
                  ...
                  <HoverCardContent className="w-80 shadow-lg">
                    <div className="space-y-2">
                      ...
                      {index === 0 && <p className="text-xs text-gray-500">Integrate all your construction data sources into one comprehensive tracking system.</p>}
                      {index === 1 && <p className="text-xs text-gray-500">Transform raw data into actionable insights with intelligent dashboards and forecasting.</p>}
                      {index === 2 && <p className="text-xs text-gray-500">Ensure successful adoption with comprehensive training and round-the-clock support.</p>}
                    </div>
                  </HoverCardContent>
                </HoverCard>)}
            </div>
