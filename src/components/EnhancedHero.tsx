import { ArrowRight, Code, Cpu, Layers, MessageSquare, Play } from "lucide-react";
  ...
  return (
    ...
    >
          ...
          <motion.div className="space-y-8 z-10" variants={itemVariants}>
            <div className="space-y-6">
              ...
              >
                ...
                <span className="text-sm font-medium text-primary">Construction Technology Leaders</span>
              </motion.div>
              ...
              >
                ...
                advanced tracking systems, and predictive analytics that reduce delays and optimize performance.
              </motion.p>
            </div>
      ...
      <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8 -mt-20">
        ...
        >
          {[
            { icon: Cpu, title: "Real-Time Tracking", desc: "RTLS, RFID, and QR-code systems for accurate monitoring" },
            { icon: Code, title: "Smart Dashboards", desc: "Visual reporting via Power BI with predictive analytics" },
            { icon: Layers, title: "Productivity Insights", desc: "Forecast timelines and optimize resource allocation" }
          ].map((feature, index) => (
            <motion.div 
              key={index}
