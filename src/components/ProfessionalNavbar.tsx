  ...
  const projects = [
    {
      ...
      description: "Fire safety and emergency response system",
      category: "Safety",
    },
    {
      title: "Sport Retail",
      description: "Sports equipment retail solutions",
      category: "Retail",
    },
    {
      title: "Workwear",
    ...
    },
    {
      ...
      description: "Hockey analytics and tracking",
      category: "Sports",
    },
    {
      title: "Pet Tracker",
      description: "Pet tracking and monitoring system",
      category: "Consumer",
    },
  ];
                      ...
                      <div className="grid gap-3">
                        <div className="mb-4">
                          ...
                          <p className="text-sm text-muted-foreground">
                            Explore our innovative solutions across different
                            industries
                          </p>
                        </div>
          ...
          >
            <div className="px-4 py-6 space-y-4 max-h-[80vh] overflow-y-auto">
              {[
                ...
                {
                  label: "Why Construction Data",
                  action: () => scrollToSection("why-construction"),
                },
                {
                  label: "How We Work",
