...
const SEO: React.FC<SEOProps> = ({
  ...
  const organizationStructuredData = {
    ...
    sameAs: [
      ...
      "https://twitter.com/CO Consultantstechnologies",
    ],
  };
  ...
  const blogPostStructuredData =
    isBlogPost && publishDate
      ? {
          ...
          author: {
            "@type": "Organization",
            name: author || "CO Consultants Technologies",
            url: "https://CO Consultants.com",
          },
          publisher: {
            "@type": "Organization",
  ...
  return (
    <Helmet>
      ...
      <meta property="og:site_name" content="CO Consultants Technologies" />
      ...
      {isBlogPost && (
        <meta
          ...
          content="https://CO Consultants.com"
        />
      )}
      ...
      <meta name="twitter:site" content="@CO Consultantstechnologies" />
      <meta name="twitter:creator" content="@CO Consultantstechnologies" />
